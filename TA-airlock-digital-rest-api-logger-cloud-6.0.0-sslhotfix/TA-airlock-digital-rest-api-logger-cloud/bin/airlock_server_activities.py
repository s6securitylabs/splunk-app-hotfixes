...
import input_module_airlock_server_activities as input_module
...
'''
    ...
    Add your modular input logic to file input_module_airlock_server_activities.py
'''
class ModInputairlock_server_activities(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputairlock_server_activities, self).__init__("ta_airlock_digital_rest_api_logger_cloud", "airlock_server_activities", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputairlock_server_activities, self).get_scheme()
        scheme.title = ("Airlock Server Activities")
...
if __name__ == "__main__":
    exitcode = ModInputairlock_server_activities().run(sys.argv)
    sys.exit(exitcode)
